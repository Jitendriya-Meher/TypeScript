...
const bigNumLiteral: bigint = 1234567890123456789012345678901234567890n;
const bigNumConstructor: bigint = BigInt("1234567890123456789012345678901234567890");
...
const add:bigint = bigNumLiteral + bigNumConstructor;

const subtract:bigint = bigNumLiteral - 
bigNumConstructor;

const multiply:bigint = bigNumLiteral * bigNumConstructor;

const divide:bigint = bigNumLiteral / bigNumConstructor;
